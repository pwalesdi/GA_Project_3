...
•Two jupyter notebooks:
	-The first contains the data gathering information and process and the second contains the data 	modeling process and visualization.
•A .csv file of our scrapped data
